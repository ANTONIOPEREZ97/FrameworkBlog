...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $writerRole = Role::create(['name' => 'Autor', 'display_name' => 'Autor']);
        ...
        $admin = new User;
        $admin->name = 'Darinel Cigarroa';
        $admin->email = 'darinel@gmail.com';
        $admin->password = '123123';
        $admin->save();
        $admin->assignRole($adminRole);
        
        $admin = new User;
        $admin->name = 'Antonio Jimenez';
        $admin->email = 'antonio@gmail.com';
        $admin->password = '123123';
        $admin->save();
        $admin->assignRole($adminRole);

        $writer = new User;
        $writer->name = 'Fernando Lopez';
        $writer->email = 'Fernando@gmail.com';
